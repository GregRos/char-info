...
export interface StaticIndicators {
    /**
     * Returns an object that can test whether a character is part of the given Unicode block.
     * @param block The block name. Spaces, underscores, dashes, commas, etc. are ignored.
     */
    block(block : string) : CharClassIndicator;
    /**
     * Returns an object that can test whether a character is in the given Unicode category.
     * @param category The category name. May be the short name or the long name. Spaces, underscores, dashes, etc. are ignored.
     */
    category(category : string) : CharClassIndicator;
    /**
     * Returns an object that an test whether a character is in a given Unicode script.
     * @param script The script name. Spaces, underscores, dashes, etc. are ignored.
     */
...
export interface StaticCodeInfo {
    ...
    /**
     * Checks if the codepoint is a Unicode decimal digit, including script-specific forms of decimal digits but not including typographic variants like subscripts and superscripts.
     * @param code The codepoint.
     */
    ...
    /**
     * Checks if the codepoint is a Unicode letter, including letters in different scripts but not including letter-like symbols such as roman numerals.
     * @param code The codepoint.
     */
    ...
    /**
     * Checks if the codepoint is a Unicode upper-case letter, including letters in different scripts. Note that some letters are neither upper- nor lower-case.
     * @param code The codepoint.
     */
    ...
    /**
     * Checks if the codepoint is a Unicode lower-case letter, including letters in different scripts. Some letters are neither upper- nor lower-case.
     * @param code The codepoint.
     */
    ...
    /**
     * Checks if the codepoint is a Unicode inline space, i.e. has the "Separator, Space" category.
     * @param code The codepoint.
     */
    isUniSpace(code : number) : boolean;
    /**
     * Checks if the codepoint is a common ASCII line terminator character. Only \r and \n are recognized.
     * @param code The codepoint.
     */
    isNewline(code : number) : boolean;
    /**
     * Checks if the codepoint is any of a number of characters that could be considered line terminators, including: U+2029 PARAGRAPH SEPARATOR.
     *
     * This also includes some additional ASCII characters, such as U+000B VERTICAL TAB.
     * @param code The codepoint.
     */
    isUniNewline(code : number) : boolean;
    /**
     * Checks if the codepoint could be considered an ASCII word character. This is [0-9a-zA-Z-_].
     * @param code The codepoint
     */
    isWordChar(code : number) : boolean;

    /**
     * Checks if the character is any of a number of characters that could be considered a word character.
     * @param code The codepoint
     */
...
export interface StaticCharInfo {
    ...
    /**
     * Checks if the codepoint is any of a string of characters that could be considered line terminators, including: U+2029 PARAGRAPH SEPARATOR.
     *
     * This also includes some additional ASCII characters, such as U+000B VERTICAL TAB.
     * @param char The codepoint.
     */
    ...
    /**
     * Checks if the character is any of a string of characters that could be considered a word character.
     * @param char The codepoint
     */
...
/**
 * An object that can determine if a given codepoint or character is part of some single Unicode group.
 */
export interface CharClassIndicator {
    /**
     * The unicode group for which this object is an indicator for, e.g. "Letter, Titlecase"
     */
    description : string;
    /**
